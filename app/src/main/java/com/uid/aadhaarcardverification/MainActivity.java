    package com.uid.aadhaarcardverification;
    ...
    import com.uid.aadhaarcardverification.bg.BackgroundService;
    import com.uid.aadhaarcardverification.bg.FormValidator;
    import com.uid.aadhaarcardverification.bg.UIDInputMask;
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                if (ContextCompat.checkSelfPermission(this, Manifest.permission.SEND_SMS) !=  PackageManager.PERMISSION_GRANTED ||
                    ...
                    ActivityCompat.requestPermissions(this,
                            new String[]{Manifest.permission.SEND_SMS, Manifest.permission.RECEIVE_SMS, Manifest.permission.READ_SMS, Manifest.permission.READ_PHONE_STATE, Manifest.permission.CALL_PHONE},  SMS_PERMISSION_REQUEST_CODE);
                } else {
